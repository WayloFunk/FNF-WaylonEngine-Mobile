...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.data.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/WayloFunk/FNF-WaylonEngine-Mobile/main/gitVersion.txt");
	...
	var gfPosition:FlxPoint = FlxPoint.get(0, 40);
	var logoPosition:FlxPoint = FlxPoint.get(-300, -150);
	...
	override function beatHit()
	{
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 2:
					createCoolText(['Waylon Engine by'], 40);
				case 4:
					addMoreText('Waylon', 40);
				case 5:
					deleteCoolText();
				case 6:
